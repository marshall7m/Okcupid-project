...
Preference for possible matches- 
Question for each topic: 
What x (e.g. body type) do you prefer for match?
On a scale from 1-10, how important is it for your preference to be met?
...
Answer regarding self (person taking questionaire)
